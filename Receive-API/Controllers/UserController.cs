...
namespace Receive_API.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        [HttpPost("getUsers")]
        public async Task<IActionResult> GetUsers([FromQuery]PaginationParams param,Userparam userparam) {
            var users = await _serviceUser.GetWithPaginations(param,userparam.UserID);
